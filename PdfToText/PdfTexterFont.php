...
use PdfToText\Maps\Adobe\PdfTexterAdobeMacRomanMap;
use PdfToText\Maps\Adobe\PdfTexterAdobeWinAnsiMap;
use PdfToText\Maps\PdfTexterEncodingMap;
use PdfToText\Maps\PdfTexterIdentityHCIDMap;
use PdfToText;
 ...
 * @package PdfToText
 */
class  PdfTexterFont extends PdfToText\PdfObjectBase {
	...
	public function __construct($resource_id, $cmap_id, $font_type, $secondary_cmap_id = null, $pdf_objects = null, $extra_mappings = null, $font_variant = false) {
		...
		if (preg_match('#/SubType \s* /Type1#ix', $font_data)) {
			...
			if (isset (PdfToText\PdfToText::$AdobeStandardFontMetrics [$lc_font_name])) {
				$metrics_file = PdfToText\PdfToText::$FontMetricsDirectory . '/' . PdfToText\PdfToText::$AdobeStandardFontMetrics [$lc_font_name];
