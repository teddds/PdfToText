...
use PdfToText\Maps\Adobe\PdfTexterAdobeUndocumentedUnicodeMap;
use PdfToText;

/***
 * Class PdfTexterUnicodeMap
 *  A class for fonts having a character map specified with the /ToUnicode parameter.
 * @package PdfToText
 */
class  PdfTexterUnicodeMap extends PdfToText\Maps\PdfTexterCharacterMap {
