...
class  PdfToTextCaptureArea   {
	...
	if ($left === false)
		error(new \PdfToText\Exceptions\PdfToTextCaptureException ("Attribute \"left\" is mandatory."));
	else
		$left = ( double )$left;

	if ($top === false)
		error(new \PdfToText\Exceptions\PdfToTextCaptureException ("Attribute \"top\" is mandatory."));
	else
		$top = ( double )$top;
	...
	if ($right === false) {
		if ($width === false)
			error(new \PdfToText\Exceptions\PdfToTextCaptureException ("Either the \"right\" or the \"width\" attribute must be specified."));
		else
	...
	if ($bottom === false) {
		if ($height === false)
			error(new \PdfToText\Exceptions\PdfToTextCaptureException ("Either the \"bottom\" or the \"height\" attribute must be specified."));
		else
