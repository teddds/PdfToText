...
use PdfToText\Encryption\PdfRC4DecryptionAlgorithm;
 ...
 */
abstract class    PdfDecryptionAlgorithm {
	...
	public static function GetInstance($encryption_data) {
		switch ($encryption_data->EncryptionAlgorithm) {
			case    \PdfToText\Encryption\PdfEncryptionData::PDFCRYPT_ALGORITHM_RC4 :
